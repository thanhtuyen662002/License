        ...
        <form action="#">
            <div class="user-details">
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Vui lòng nhập họ tên" required>
                </div>

                <div class="input-box">
                    <span class="details">Tuổi</span>
                    <input type="number" placeholder="Vui lòng nhập số tuổi" required>
                </div>

                <div class="input-box">
                    <span class="details">CCCD</span>
                    <input type="text" placeholder="Vui lòng nhập CCCD" required>
                </div>

                <div class="input-box">
                    <span class="details">Phone Number</span>
                    <input type="text" placeholder="Vui lòng nhập SĐT" required>
                </div>

                <div class="input-box">
                    <span class="details">Địa chỉ</span>
                    <input type="text" placeholder="Vui lòng nhập địa chỉ" required>
                </div>

                <div class="input-box">
                    <span class="details">Ngày tháng năm sinh</span>
                    <input type="date" placeholder="Vui lòng chọn ngày sinh" required>
                </div>
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Vui lòng nhập mật khẩu" required>
                </div>
